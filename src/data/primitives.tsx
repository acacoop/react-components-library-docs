...
import { Button } from '@acacoop/react-components-library/primitives';`,
  props: [
    ...
    },
    {
      ...
      type: "string",
      default: "-",
      description: "Texto del botón (alternativa a children)",
    },
    {
      name: "icon",
      type: "ReactNode",
      default: "-",
      description: "Ícono personalizado (componente de Lucide u otro)",
    },
    {
      name: "iconPosition",
      type: '"left" | "right"',
    ...
    },
    {
      ...
      default: "-",
      description: "Callback cuando el mouse entra o sale del botón",
    },
    {
      name: "onClick",
      type: "() => void",
...
import { Breadcrumbs } from '@acacoop/react-components-library/primitives';`,
  props: [
    ...
    },
    {
      ...
      type: "boolean",
      default: "false",
      description: "Muestra un botón de volver antes de los breadcrumbs.",
    },
    {
      name: "onBackClick",
      type: "() => void",
      default: "-",
      description: "Callback cuando se hace click en el botón de volver.",
    },
    {
      name: "backButtonIcon",
      type: "ReactNode",
      default: "<ArrowLeft />",
      description: "Ícono personalizado para el botón de volver.",
    },
    {
      name: "backButtonText",
      type: "string",
      default: "-",
      description: "Texto del botón de volver. Si no se proporciona, solo muestra el ícono.",
    },
    {
      name: "backButtonLabel",
      type: "string",
      default: '"Volver"',
      description: "Label para el botón de volver (accesibilidad).",
    },
    {
      name: "backButtonVariant",
      type: '"primary" | "secondary" | "destructive" | "outline" | "ghost" | "link"',
      default: '"ghost"',
      description: "Variante visual del botón de volver.",
    },
    {
      name: "backButtonIconPosition",
      type: '"left" | "right"',
      default: '"left"',
      description: "Posición del ícono en el botón de volver.",
    },
    {
      name: "backButtonPosition",
      type: '"left" | "right"',
      default: '"left"',
      description: "Posición del botón de volver respecto a los breadcrumbs.",
    },
  ],
  sections: [],
};
